...
export namespace OpenapiApiTypes {
...
export type HTTPMethod =
  ...
  /** Returns a single pet **/
  getPetByIdTest: InContextSdkMethod<Query['getPetByIdTest'], QuerygetPetByIdTestArgs, MeshContext>,
  /** Returns a map of status codes to quantities **/
  ...
  export type Context = {
      ["OpenapiApi"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
