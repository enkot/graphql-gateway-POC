...
import type { OpenapiApiTypes } from './sources/OpenapiApi/types';
...
export type QuerygetPetByIdTestArgs = {
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getPetByIdTest?: Resolver<Maybe<ResolversTypes['Pet']>, ParentType, ContextType, RequireFields<QuerygetPetByIdTestArgs, 'petId'>>;
...
export type MeshContext = OpenapiApiTypes.Context & BaseMeshContext;
